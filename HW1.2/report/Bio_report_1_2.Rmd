...
The results are shown in **Figure 3** and **Figure 4**. What comes out is that considering union largest connected component the two algorithms produce more clusters than intersection LCC: in partucilar, Louvain algorithm produces 7 and 9 modules for, respectively, intersection and union while MCL algorithm produces 9 and 13 clusters. 
...
|                        |                                      Putative disease module                                      |
|:----------------------:|:-------------------------------------------------------------------------------------------------:|
|        Module id       |                                                 1                                                 |
|  Clustering Algorithm  |                                              Louvain                                              |
|  Number of seed genes  |                                                 4                                                 |
|     Number of genes    |                                                 16                                                |
|   List of seed genes   |                                    [CDY1B, TSPY1, KDM5D, CDY1]                                    |
| List of non seed genes | [HIST1H4A, PCGF6, UBC, HIST2H2AC, EEF1A1, CSNK2A1, AR,  KMT2A, REV3L, HIST3H3, HIST2H2BE, EEF1A2] |
|         p-value        |                                               0,034                                              
Table: Putative disease module
